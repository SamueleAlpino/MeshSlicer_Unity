...
public class EditorTool : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        //Update cutter settings
        tool.Update(toCut, fillerMaterial, (uint)numberOfCuts, prefabName);
    ...
    private class CutterTool
    {
       ...
       //     Instantiate(ToCut);
        ...
        {
            //Initialized
            root       = Instantiate(new GameObject(PrefabName));
            AllObjects = new List<GameObject>();
            toSave     = new Mesh();
            pieces = new GameObject[]{new GameObject(),
                                      new GameObject()};
            ...
            GameObject toCut = Instantiate(ToCut);
            //Cut the Mesh
            Slicer.Cut(ref pieces, toCut, toCut.transform.position + toCut.GetComponent<MeshFilter>().sharedMesh.bounds.center, new Vector3(Random.Range(minRange, maxRange), Random.Range(minRange, maxRange), Random.Range(minRange, maxRange)), FillerMaterial, preAllocation[0]);
        ...
        {
            Vector3 cutPosition = node.transform.position + node.GetComponent<MeshFilter>().sharedMesh.bounds.center;
